...
small! Take a look at the [community contributing notes](https://github.com/ipfs/community/blob/master/contributing.md). Please make sure to check the [issues](https://github.com/djbarber/ipfs-hack/issues). Search the closed ones
...
- ask questions or talk about things in [Issues](https://github.com/djbarber/ipfs-hack/issues) or #ipfs on freenode.
